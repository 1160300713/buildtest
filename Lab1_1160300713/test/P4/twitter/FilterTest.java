...
public class FilterTest {
	...
	private static final Tweet tweet2 = new Tweet(2, "bbitdiddle",
			"How ironic that only the wealthy elite can hear Michelle Obama speak. Heck, I can not even afford parking in the area let alone $$$ tix.",
			d2);
	private static final Tweet tweet3 = new Tweet(3, "h0llaJess", "rivest talk in 30 minutes #hype", d3);
	private static final Tweet tweet4 = new Tweet(4, "DCiszczon",
			"RT @MsMcMullan: Am I the only one who knows with complete certainty that the GOP never would have let the Democrats steal their Supreme Cou\\u2026",
			d4);
	private static final Tweet tweet5 = new Tweet(5, "alyssa",
			"RT @StevenTDennis: DACA exists because Obama acted after a Senate minority filibustered the DREAM Act in 2010; John Boehner and Paul Ryan h\\u2026",
			d5);
	...
	public void testWrittenByMultipleTweetsSingleResult() {
		...
		assertTrue("expected list to contain tweet", writtenBy.contains(tweet1) && writtenBy.contains(tweet5));
	}
	...
	public void testInTimespanMultipleTweetsMultipleResults() {
		...
		assertTrue("expected list to contain tweets", inTimespan.containsAll(Arrays.asList(tweet1, tweet2, tweet4)));
